...
export default function CreatorPage() {
  ...
  return (
    <CVProvider>
      <div className="pb-4 lg:mt-8 xl:mt-11 md:mt-6 mt-6 mr-1 ml-0 sm:mr-4 sm:ml-3.5 md:mr-8 md:ml-7 xl:mr-15 xl:ml-15 h-[calc(87vh)] xl:h-[calc(87vh)] overflow-hidden">
