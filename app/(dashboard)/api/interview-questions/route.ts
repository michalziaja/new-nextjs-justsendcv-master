...
export async function POST(req: Request): Promise<NextResponse> {
  ...
  const userPrompt = `
    ...
    - Doświadczenie zawodowe (1 pytania)
    - Umiejętności techniczne i kompetencje 1 pytania)
    - Pytania behawioralne i sytuacyjne (1 pytania)
    - Motywację i dopasowanie do firmy ${company} (1 pytania)
    - Oczekiwania i plany zawodowe (1 pytania)
