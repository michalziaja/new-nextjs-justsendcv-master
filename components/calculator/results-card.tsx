...
export const ResultsCard: React.FC<ResultsCardProps> = ({ results, calcDirection }) => {
  // Obliczenie łącznych obciążeń pracownika (wszystkie składki + podatek)
  ...
  // Procent obciążeń od kwoty brutto
