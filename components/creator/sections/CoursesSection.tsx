...
interface CoursesSectionProps {
  cvData: CVData;
  updateCourse: (index: number, field: string, value: string) => void;
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="p-4 ml-6">
        ...
        <div className="space-y-3 max-h-[calc(60vh-7rem)] overflow-y-auto pr-2 pb-2"
          style={{
            scrollbarWidth: 'thin',
          ...
          {(cvData.courses || []).map((course, index) => (
            <div key={index} className="border rounded-lg p-4 space-y-3 mb-4 relative">
              ...
              <div className="grid grid-cols-2 gap-4 mt-3">
                <div>
                  ...
                  <input 
                    ...
                    onChange={(e) => updateCourse(index, 'organizer', e.target.value)}
                  />
                </div>
                <div>
                  ...
                  <input 
                    ...
                    onChange={(e) => updateCourse(index, 'certificateNumber', e.target.value)}
                  />
                </div>
              </div>
              ...
              <div className="mt-3">
                ...
                />
                <textarea 
                  className="w-full border rounded-t-none rounded-b-md px-3 py-2" 
                  placeholder="Opisz czego dotyczy kurs lub jakie umiejętności zdobyłeś"
                  rows={3}
                  value={course.description || ''}
