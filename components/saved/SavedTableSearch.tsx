...
export function SavedTableSearch({ searchQuery, onSearchChange }: SavedTableSearchProps) {
  return (
    <div className="relative w-45 sm:w-50 md:w-50 lg:w-50 xl:w-57 ml-0 border-0 bg-white dark:bg-sidebar shadow-md border-cyan-500 dark:border-gray-700 rounded-md">
